...
To generate a Fibonacci sequence, a user should enter an integer into the inout field and press 'Generate'.
...
Entering some value into the input and pressing 'Add' creates an element with 0 index value. For a split second the element's color turns violet. Pressing 'Delete' removes the last element from the queue. By pressing 'Clear' the user deletes all queue elements at the same tinme.
